    ...
    class SL900AGetSensorValueTest
    {
        static void Usage()
        {
            Console.WriteLine(String.Join("\r\n", new string[] {
                    ...
                    "Sample <sensor> types TEMP, EXT1, EXT2, BATTV"                
            }));
            Environment.Exit(1);
        }
        ...
        private void setupReaderConfiguration() {
            ...
            Boolean checkPort = (Boolean)reader.ParamGet("/reader/antenna/checkPort");
            String swVersion = (String)reader.ParamGet("/reader/version/software");
