    ...
    class LicenseKey
    {
        static void Usage()
        {
            Console.WriteLine(String.Join("\r\n", new string[] {
                    ...
                    "tmr:///com4 --option <license operation> --key <license key>",
                    "tmr://my-reader.example.com --option <license operation> --key <licence key>",
                    "Example: 'tmr:///com4 --option set --key AB CD'",
                    "Example: 'tmr:///com4 --option erase'",
                    "Example: 'tmr://10.2.0.224 --option set --key AB CD'",
                }));
            Environment.Exit(1);
        }
